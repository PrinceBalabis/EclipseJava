...
public class TextWindow {
	 ...
	 * 
	 * @param txt
	 *            Texten som ska visas i TextWindow
	 */
	...
	/**
	 * Ändrar innehållet som syns i TextWindow till den sträng som genereras av
	 * objektets toString-metod.
	 * 
	 * @param obj
	 *            objektet vars toString-metod genererar texten som visas i
	 *            TextWindow
	 */
	 ...
	 * 
	 * @param txt
	 *            texten som läggs till sist i TextWindow
	 */
	 ...
	 * 
	 * @param obj
	 *            objektet vars toString-metod genererar texten som läggs till
	 *            sist i TextWindow
	 */
	...
	/**
	 * Lägger till txt sist i TextWindow. Nästa text som läggs till kommer på ny
	 * rad.
	 * 
	 * @param txt
	 *            texten som läggs till sist i TextWindow
	...
	/**
	 * Lägger till strängen som obj.toString() genererar sist i TextWindow.
	 * Nästa text som läggs till kommer på ny rad.
	 * 
	 * @param obj
	 *            objektet vars toString-metod genererar texten som läggs till
	 *            sist i TextWindow
